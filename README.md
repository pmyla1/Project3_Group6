...
**Polyploidy** and **whole genome duplications** (WGD) occur throughout **all kingdoms** of life and are especially **ubiquitous in plants**. WGD is a **major mutation** that disrupts **ionomic**, **cellular**, and **meiotic** processes, and **neo-polyploids** must overcome various challenges including **genomic instability** and **chromosomal mis-segregation** during meiosis (Margburger et al., 2019 [Nature](https://www.nature.com/articles/s41467-019-13159-5)). One of the immediate challenges in neo-polyploids is the **formation of multivalent crossovers** between homologous chromosomes during meiosis, which can lead to **entanglement** and **chromosomal breakage** at anaphase I (Bray et al., 2023). If neo-polyploids **overcome** the initial challenges related to meiosis and genome instability, they can become **established** as a **polyploid lineage**. For a graphical overview of the chromosomal entanglement and multivalent formation in neo-polyploids during metaphase I of meisosis see below. 


<img width="693" alt="Screenshot 2024-04-22 at 13 41 29" src="https://github.com/pmyla1/Project3_Group6/assets/151543531/592ded6d-b385-4c9f-899f-0094c4f2c111">

Caption: The **top row** shows **bivalent** metaphase I chromosomes in **diploids**, the **middle row** shows **multivalent** metaphase I chromosomes in **neo-polyploids**, and the **bottom row** shows **bivalent** metahpase I chromosomes in **stable autopolyploids**.  


Source: [Yant, L., Hollister, J. D., Wright, K. M., Arnold, B. J., Higgins, J. D., Franklin, F. C. H., & Bomblies, K. (2013). Meiotic adaptation to genome duplication in Arabidopsis arenosa. Current biology : CB, 23(21), 2151–2156. https://doi.org/10.1016/j.cub.2013.08.059](https://doi.org/10.1016/j.cub.2013.08.059)  
